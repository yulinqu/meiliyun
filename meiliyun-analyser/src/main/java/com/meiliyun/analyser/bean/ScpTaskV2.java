...
public class ScpTaskV2 {
    ...
    public static String init_time = "2017-01-01 00:00:00";

    private static Logger LOGGER = Logger.getLogger(ScpTaskV2.class);

    public void initTime() {
        init_time = "2017-01-01 00:00:00";
    }
    ...
    public void scpFile() throws IOException, SQLException {
        ...
        meiliyunDAO.deletePvuv(init_time);
        meiliyunDAO.deletePclick(init_time);
        ...
        if (localFile.isFile() && localFile.exists()) { // 判断文件是否存在
            ...
            while ((lineTxt = bufferedReader.readLine()) != null) {
                try {
                    ...
                    if (reTime.compareToIgnoreCase(init_time) >= 0) {
                        // 如果当前时间大于等于初始化时间
                        init_time = reTime;
                                            ...
                                            if (preBannerClick.get(reTime).get(url) != null) {
                                                ...
                                                if (preBannerClick.get(reTime).get(url).get(channel) != null) {
                                                    ...
                                                    if (preBannerClick.get(reTime).get(url).get(channel)
                                                        ...
                                                        if (preBannerClick.get(reTime).get(url).get(channel)
                                                                .get(position).get(pid) != null) {
                                                            preBannerClick.get(reTime).get(url).get(channel)
                                                                    .get(position).get(pid).add(pid);
                                                        } else {
                                                            preBannerClick.get(reTime).get(url).get(channel)
                                                                    .get(position).put(pid, new ArrayList<String>());
                                                            preBannerClick.get(reTime).get(url).get(channel)
                                                                    .get(position).get(pid).add(pid);
                                                        }
                                            ...
                                            if (preButtonClick.get(reTime).get(url) != null) {
                                                ...
                                                if (preButtonClick.get(reTime).get(url).get(channel) != null) {
                                                    ...
                                                    if (preButtonClick.get(reTime).get(url).get(channel)
                                                        ...
                                                        if (preButtonClick.get(reTime).get(url).get(channel)
                                                                .get(position).get(pid) != null) {
                                                            preButtonClick.get(reTime).get(url).get(channel)
                                                                    .get(position).get(pid).add(pid);
                                                        } else {
                                                            preButtonClick.get(reTime).get(url).get(channel)
                                                                    .get(position).put(pid, new ArrayList<String>());
